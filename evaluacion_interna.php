    ...
    <head>
		...
		var informacion = []; 
            $(function () {
				...
				$.ajax({
					  method: "POST",
					  url: "php/obtener_puesto_interno_mtd.php",
					  dataType: "json"
					  }).done(function(data){
               ...
               <img src="img/logo.jpg" height="200" id="logo">
				...
				<div class="centrado">
					<form id="formulario" action="cuestionario.php" method="post" style="width: 50%; margin: 0 auto">
						<h3></span>Seleccione el examen que aplicar&aacute</h3>
						<select class="form-control" id="puesto" name="puesto">
                        <option value="0">Ex&aacute;menes a seleccionar</option>
				  ...
				  <div id="informacion" style="display:none">
                    ...
                    <div class="col-md-6">
							...
							<input type="text" onkeypress="return pulsar(event)" class="form-control" id="mail" name="mail" placeholder="E-mail de la empresa"  required>
